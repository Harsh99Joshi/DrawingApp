...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ibGallery.setOnClickListener{
            if(isReadStorageAllowed()){
                //run code to get image from storage
    ...
    private fun showBrushSizeDialog() {
        ...
        val smallButton = brushDialog.findViewById<AppCompatImageButton>(R.id.ib_small_brush)
        smallButton.setOnClickListener {
            drawing_view.setBrushSize(10.toFloat())
            brushDialog.dismiss()
        }

        val mediumButton = brushDialog.findViewById<AppCompatImageButton>(R.id.ib_medium_brush)
        ...
        val largeButton = brushDialog.findViewById<AppCompatImageButton>(R.id.ib_large_brush)
